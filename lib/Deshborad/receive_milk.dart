...
enum SingingCharacter { Individual, Dairy }

class Receive_Milk extends StatefulWidget {
  Receive_Milk({
    super.key,
  });

  @override
  State<Receive_Milk> createState() => _Receive_MilkState();
}

class _Receive_MilkState extends State<Receive_Milk> {
  String Milktyps = "";
